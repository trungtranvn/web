        ...
        <div class="main-block">
            <form action="/">
                <div>
                    ...
                    <!-- <h5>năm sinh</h5> -->
                    <div style="float: left;width: 50%;" class="form-group form-inline gender-box "> <label>Ca học <em style="line-height: 1">(*)</em></label>
                ...
                <div class="form-group form-inline box-gaden " style="width:50%;float:left;"> <label>Tòa nhà <em style="line-height: 1">(*)</em></label>

                    <select style=" background-color: white;" id="input66076" name="fields[startProvinceId]" class="form-control" data-x-cascade="fields[countryStartPlace]:parentId">
                        ...
                        <option value="trungtamcntt">Trung tâm công nghệ thông tin</option>
