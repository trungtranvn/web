                    ...
                    <nav class="navbar navbar-expand-lg ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <!-- <li class="nav-item" href="#">
                                    <a class="nav-link" href="test.html">test</a></li> -->
        ...
        <div class="services_main">
            <div class="container">
                <div class="creative_taital">
                    <h1 class="creative_text">Đội phát triển website khai báo thông tin phong chống dịch bệnh COVID-19</h1>
                    <table>
                    <tr>
                    <td style="width: 25%;"><a href="https://www.facebook.com/tran.trung.3382/"><img width="100%"  src="images/avt1.jpg"></a></td>
                    <td style="width: 25%;"><a href="https://www.facebook.com/eri.ko.1610"><img width="100%"  src="images/avt2.png"></a></td>
                    <td style="width: 25%;"><a href="https://www.facebook.com/xuyen26021999"><img width="100%"  src="images/avt3.jpg"></a></td>
                    <td style="width: 25%;"><a href="https://www.facebook.com/manansala.maianh"><img width="100%"  src="images/avt4.png"></a></td>
                    </tr>
                    
                    </table>
                    <!-- <p style="color: #050000; text-align: center;">ĐÂY LÀ TÀI LIỆU QUAN TRỌNG, THÔNG TIN CỦA ANH/CHỊ SẼ GIÚP CƠ QUAN Y TẾ LIÊN LẠC KHI CẦN THIẾT ĐỂ PHÒNG CHỐNG DỊCH BỆNH TRUYỀN NHIỄM
Khuyến cáo: Khai báo thông tin sai là vi phạm pháp luật Việt Nam và có thể xử lý hình sự</p> -->
                    <!-- <div class="btn_main">
